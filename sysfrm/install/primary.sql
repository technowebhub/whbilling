...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 04, 2015 at 06:22 AM
...
`id` int(11) NOT NULL,
  `account` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `zip` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  ...
  `ts` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `img` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `web` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `facebook` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `google` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
`id` int(11) NOT NULL,
  ...
  `icon` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `stime` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `sdate` date NOT NULL,
  `o` int(11) NOT NULL DEFAULT '0',
  `oname` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
...
`id` int(10) NOT NULL,
  ...
  `qty` varchar(20) COLLATE utf8_unicode_ci NOT NULL DEFAULT '1',
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1190 ;
...
`id` int(10) NOT NULL,
  ...
  `paymentmethod` text COLLATE utf8_unicode_ci NOT NULL,
  `notes` text COLLATE utf8_unicode_ci NOT NULL,
  `vtoken` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `ptoken` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `r` varchar(100) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
...
`id` int(11) NOT NULL,
  ...
  `c5` text COLLATE utf8_unicode_ci NOT NULL,
...
(1, 'Paypal', 'Paypal Email', 'pay@bdinfosys.com', 'paypal', 'Invoices', 'USD', '1', '', '', '', 'Active', 1),
...
INSERT INTO `sys_pl` (`id`, `name`, `c`, `url`, `icon`, `status`, `sorder`) VALUES
(1, 'FLMCS', 'flmcs', 'flmcs/init/list-services', 'fa fa-paper-plane-o', 0, 0);
...
(1, 'demo@example.com', 'Administrator', '', '$1$WN..nD2.$Vo9niDl/fUf0VhheEjmHe/', 'Admin', 'Active', '2015-04-03 23:14:52', '', '2014-10-20 01:43:07', 'No', 'No', '$1$ZW/.uF5.$.rwCeLiguoBzYzf3waOnY1', '', 'No', '', '0');
